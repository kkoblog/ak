        ...
        >
          <div className="mt-16 bg-gradient-to-br from-[#1E1E1E]/80 to-[#252525]/80 rounded-3xl p-12 transform hover:scale-[1.02] transition-all duration-500 shadow-2xl border border-[#0496FB]/20 backdrop-blur-lg">
            <div className="text-center space-y-12">
              <div className="relative">
                <h3 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#0496FB] via-[#04FB43] to-[#0496FB] pb-4 px-4 leading-relaxed">
              ...
              <div className="space-y-8">
                <div className="relative inline-block bg-[#1A1A1A]/60 backdrop-blur-md px-8 py-4 rounded-2xl border border-[#0496FB]/10">
                ...
                <div className="relative">
                  ...
                  >
                    <div className="flex items-center justify-center gap-4 md:gap-6">
                      <span className="text-2xl md:text-5xl font-bold">DM予約</span>
                      <svg className="w-8 h-8 md:w-14 md:h-14" fill="currentColor" viewBox="0 0 24 24">
