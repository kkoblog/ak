                  ...
                  <div className="relative z-10 space-y-4 md:space-y-6 max-w-3xl mx-auto">
                    <div className="bg-[#1E1E1E]/90 backdrop-blur-sm rounded-xl p-4 md:p-6 transform hover:scale-105 transition-all duration-300">
                      <p className="text-base md:text-2xl">
                        ...
                        毎日8時間以上、やりたくもない仕事をし人生が終わるように思っている
                      </p>
                    </div>
                    <div className="bg-[#1E1E1E]/90 backdrop-blur-sm rounded-xl p-4 md:p-6 transform hover:scale-105 transition-all duration-300">
                      <p className="text-base md:text-2xl">
                        <span className="text-[#0496FB] mr-3">😢</span>
                        毎月５万収入を増やしたいが、SNSは全て手をつけても１円にもなっていない
                      </p>
                    </div>
                    <div className="bg-[#1E1E1E]/90 backdrop-blur-sm rounded-xl p-4 md:p-6 transform hover:scale-105 transition-all duration-300">
                      <p className="text-base md:text-2xl">
                        <span className="text-[#0496FB] mr-3">😔</span>
                        貯蓄はしているが100歳まで生きるとすると老後2000万じゃ到底足りない・・・
                      </p>
                    </div>
                    <div className="bg-[#1E1E1E]/90 backdrop-blur-sm rounded-xl p-4 md:p-6 transform hover:scale-105 transition-all duration-300">
                      <p className="text-base md:text-2xl">
                        <span className="text-[#0496FB] mr-3">😩</span>
                        会社は副業禁止。発信仲間のように私も身バレせずにマネタイズしたい
                      </p>
                    </div>
                    <div className="bg-[#1E1E1E]/90 backdrop-blur-sm rounded-xl p-4 md:p-6 transform hover:scale-105 transition-all duration-300">
                      <p className="text-base md:text-2xl">
                        <span className="text-[#0496FB] mr-3">😩</span>
                        会社員から半年以内に独立したい。コンサルも受けているが、マネタイズ額は３万以下で到底独立できそうになく焦っている
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="text-center space-y-12">
              <div className="relative">
                <h3 className="text-2xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#0496FB] via-[#04FB43] to-[#0496FB] pb-4 px-4 leading-relaxed">
                  <span className="font-black">副業診断（zoom）</span>
                </h3>
        ...
        <section ref={section4Ref} className="py-12 md:py-24">
          ...
          >
            ...
            <div className="space-y-4 md:space-y-8">
              {[
                {
                  question: "本当に顔出しなしで構築できますか？",
                  answer: "はい。ブログやkindleは匿名での運用や出版が可能です。実際に公務員の方でも顔出しなしで収益化しています。"
                },
                {
                  question: "副業未経験でも始められますか？",
                  answer: "はい。ご相談にくる10名のうち9名の方が副業未経験者です。副業未経験者でも4ヶ月で構築できる内容・サポート体制にしています。"
                },
                {
                  question: "仕事が忙しいのですが、それでもできますか？",
                  answer: "AIなどを使い、効率的に執筆を進めます。週に30分お時間捻出いただければ問題ございません。"
                },
                {
                  question: "本に出来るようなスキルなんてないのですが・・・",
                  answer: "大丈夫です。実は本にできるスキルは誰にでもあります。ヒアリングをし、一緒に本にできるスキルを見つけますのでご安心ください。"
                }
